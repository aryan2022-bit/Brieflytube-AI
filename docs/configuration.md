...
3. **Z.AI API Key**: For GLM-4.7-Flash (primary LLM model)
...
### Z.AI / GLM-4.7-Flash (Primary LLM)

Z.AI provides access to the GLM-4.7-Flash model, which supports "thinking mode" for enhanced reasoning.
...
1. **GLM-4.7-Flash** (Z.AI) - Primary model
...
Enable "thinking mode" for GLM-4.7-Flash to use enhanced reasoning for complex videos.
