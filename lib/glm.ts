...
/**
 * GLM-4.7-Flash client configuration
 *
...
/**
 * Gets or creates a GLM-4.7-Flash client using the Coding Subscription (Anthropic format).
...
/**
 * Gets or creates a GLM-4.7-Flash client using the standard PAAS API (OpenAI format).
...
/**
 * Checks if GLM-4.7-Flash is configured and available for a user.
 *
 * @param userId - The user's ID
